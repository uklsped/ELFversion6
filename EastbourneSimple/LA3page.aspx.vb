...
Partial Public Class LA3page
    Inherits System.Web.UI.Page
    Private EquipmentID As String = "LA3"
    ...
    Private LinacFlag As String = "StateLA3"
    Private appstate As String = "LogOnLA3"
    Private suspstate As String = "SuspendedLA3"
    Private actionstate As String = "ActionStateLA3"
    Private repairstate As String = "rppTabLA3"
    Private failstate As String = "FailStateLA3"
    ...
    Private faultstate As String = "faultstateLA3"
    Private linacloaded As String = "LA3loaded"
    Private returnclinical As String = "ReturnClinicalLA3"
    Private technicalstate As String = "techstateLA3"
    Private recover As String = Nothing
    Private lsctrl As LinacStatusuc
    Private RegistrationState As String = "regstateLA3"
    ...
    Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
        ...
        End If
        AddHandler LA3page.NoApprove, AddressOf ClinicalApprovedEvent
    ...
    Public Event MyEventLA3 As System.EventHandler
    ...
    Protected Sub ReportFault_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ReportFault.Click
        ...
        End If
        'Response.Redirect("faultPage.aspx?val=LA3&Tabindex=" & Tabindex & "&commentbox=" & textcomment)
    ...
    '    'Response.Redirect("RegisterUser.aspx?val=LA3&Tabindex=" & Tabindex)
    'End Sub
    ...
    Public Shared Sub CloseMessage()
        ...
        Try
            Dim lastState As String
            lastState = DavesCode.Reuse.GetLastState("LA3", 0)
            Select Case lastState
                Case "Repair", "Fault"
                    DavesCode.Reuse.SetStatus("No User", "Repair", 5, 7, "LA3", 0)
                Case Else
                    DavesCode.Reuse.SetStatus("No User", "Linac Unauthorised", 5, 7, "LA3", 0)
            End Select
        Finally
