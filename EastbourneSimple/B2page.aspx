...
<asp:Content ID="ContenB2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 ...
 <asp:HiddenField ID="LAHiddenFieldcontrol" runat="server" />
  ...
  <input id="inpHide" type="hidden" runat="server" value="9" />
        ...
        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
            ...
            <uc9:WriteDatauc ID="WriteDatauc1" LinacName="B2" UserReason="10"  Tabby="EndDay"  WriteName="EndDayData"   Visible="False" runat="server" />
...
<asp:TabPanel ID="TabPanel1" runat="server" HeaderText="B2 Engineering Runup" DynamicContextKey='Engrunup' CssClass="ajax__tab_header"><ContentTemplate>
...
<uc4:AcceptLinac ID="AcceptLinac1" runat="server" LinacName= "B2"  Tabby="1" UserReason = "1" visible="false" />
...
<asp:Panel ID="TabContenB2" runat="server" Visible="false"
><uc4:AcceptLinac ID="AcceptLinac2" LinacName="B2" UserReason="2" Tabby="2" runat="server" visible="false"/>
<uc2:Preclinusercontrol ID="Preclinusercontrol1" LinacName = "B2" DataName="PreData" runat="server"/>
</asp:Panel>
</ContentTemplate>
</asp:UpdatePanel>
</ContentTemplate>
...
<uc4:AcceptLinac ID="AcceptLinac3" LinacName="B2" UserReason="3" Tabby="3" runat="server"  />
...
<uc4:AcceptLinac ID="AcceptLinac4" LinacName="B2" UserReason="4" Tabby="4" runat="server" visible="false"/>
...
<uc4:AcceptLinac ID="AcceptLinac5" LinacName="B2" UserReason="5" Tabby="5" runat="server" visible="false"/>
...
<asp:Panel ID="TabContent6" runat="server" Visible="false"><uc4:AcceptLinac ID="AcceptLinac6" LinacName="B2" UserReason="6" Tabby="6" runat="server" visible="false"/>
...
<asp:TabPanel ID="TabPanel7" runat="server" HeaderText="B2 Emergency Run up">
...
<uc4:AcceptLinac ID="AcceptLinac7" runat="server" LinacName= "B2"  Tabby="7" UserReason = "9" visible="false" />
 <uc1:ErunupUserControlCommon ID="ErunupUserControl2" LinacName="B2" Tabby = "7" UserReason = "9" DataName="EmeData" visible="false" runat="server" />
...
<asp:TabPanel ID="TabPanel8" runat="server" HeaderText="B2 Development/Training" DynamicContextKey='Devel' CssClass="ajax__tab_header"><ContentTemplate>
...
<uc4:AcceptLinac ID="AcceptLinac8" runat="server" LinacName= "B2"  Tabby="8" UserReason = "8" visible="false" />
