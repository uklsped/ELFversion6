<%@ Page Title="" Language="VB" MasterPageFile="~/Elf.master"  AutoEventWireup="false" CodeFile="B2pageold.aspx.vb" Inherits="B2page"  %>
...
<asp:Panel ID="TabContent6" runat="server" Visible="false"><uc4:AcceptLinac ID="AcceptLinac6" LinacName="B2" UserReason="6" Tabby="6" runat="server" visible="false"/>
 ...
 <uc10:PhysicsQAuc ID="PhysicsQAuc1" LinacName="B2"  Visible="false" runat="server" />
 </asp:Panel>
 </ContentTemplate>
 </asp:UpdatePanel>
 </ContentTemplate>
