...
Partial Public Class B2page
    ...
    Private RunUpDone As String = "rppTabB2"
    Private FaultOriginTab As String = "FOTB2"
    ...
    Public Shared Sub CloseMessage()
        ...
        Try
            ...
            Select Case lastState
                Case "Repair", "Fault"
                    DavesCode.Reuse.SetStatus("No User", "Repair", 5, 7, "B2", 0, False)
                Case Else
                    DavesCode.Reuse.SetStatus("No User", "Linac Unauthorised", 5, 7, "B2", 0, False)
            End Select
        Finally
