<%@ Page Title="" Language="VB" MasterPageFile="~/Elf.master"  AutoEventWireup="false" CodeFile="LA2page.aspx.vb" Inherits="LA2page"  %>
...
<%--<asp:Button ID="RegisterUser" runat="server" Text="Register" causesvalidation="false"/>
    ...
    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
            ...
            <uc9:WriteDatauc ID="WriteDatauc1" LinacName="LA2" UserReason="10"  Tabby="EndDay"  WriteName="EndDayData"   Visible="False" runat="server" />
...
<asp:TabPanel runat="server" HeaderText="LA2 Status" ID="TabPanel0"><HeaderTemplate>
LA2 Status
</HeaderTemplate>
<ContentTemplate>
<asp:UpdatePanel ID="linacstatus" runat="server" >
    <ContentTemplate>
<%--<uc4:AcceptLinac ID="AcceptLinac0" LinacName= "LA2"  UserReason = "1"  Tabby="0" runat="server" />--%>
        <asp:UpdatePanel ID="UpdatePanel0" runat="server" >
            ...
            <%--<asp:Button ID="EndOfDay" runat="server" Text="End of Day" visible="false" causesvalidation="false" Width="200px" Height="100px"/>--%>
                    <uc5:LinacStatusuc ID="LinacStatusuc1" LinacName="LA2" runat="server" />
...
<asp:TabPanel ID="TabPanel1" runat="server" HeaderText="LA2 Engineering Runup" DynamicContextKey='Engrunup' CssClass="ajax__tab_header"><ContentTemplate>
...
<uc4:AcceptLinac ID="AcceptLinac1" runat="server" LinacName= "LA2"  Tabby="1" UserReason = "1" visible="false" />
<uc1:ErunupUserControl ID="ErunupUserControl1" LinacName="LA2" Tabby = "1" UserReason = "1" DataName="EngData" visible="false" runat="server"  />
</asp:Panel>
</ContentTemplate>
</asp:UpdatePanel>
</ContentTemplate>
...
<asp:TabPanel ID="TabPanel2" runat="server" HeaderText="LA2 Pre-clinical Runup" >
        <ContentTemplate>
...
><uc4:AcceptLinac ID="AcceptLinac2" LinacName="LA2" UserReason="2" Tabby="2" runat="server" visible="false"/>
<uc2:Preclinusercontrol ID="Preclinusercontrol1" LinacName = "LA2" DataName="PreData" runat="server"/>
</asp:Panel>
</ContentTemplate>
</asp:UpdatePanel>
</ContentTemplate>
...
<asp:TabPanel ID="TabPanel3" runat="server" HeaderText="LA2 Clinical">
        <ContentTemplate>
...
<uc3:ClinicalUserControl ID="ClinicalUserControl1"  LinacName="LA2" DataName="ClinData" runat="server" visible="false"/>
<uc4:AcceptLinac ID="AcceptLinac3" LinacName="LA2" UserReason="3" Tabby="3" runat="server"  />
</asp:Panel>
</ContentTemplate>
</asp:UpdatePanel>
</ContentTemplate>
...
<asp:TabPanel ID="TabPanel4" runat="server" HeaderText="LA2 Planned Maintenance" >
        <ContentTemplate>
...
<uc4:AcceptLinac ID="AcceptLinac4" LinacName="LA2" UserReason="4" Tabby="4" runat="server" visible="false"/>
<uc6:PlannedMaintenanceuc ID="PlannedMaintenanceuc1" linacname="LA2" runat="server" Visible="false" />
</asp:Panel>
</ContentTemplate>
</asp:UpdatePanel>
</ContentTemplate>
  ...
  <asp:TabPanel ID="TabPanel5" runat="server" HeaderText="LA2 Repair" >
        <ContentTemplate>
...
<uc4:AcceptLinac ID="AcceptLinac5" LinacName="LA2" UserReason="5" Tabby="5" runat="server" visible="false"/>
<uc7:Repairuc ID="Repairuc1" LinacName="LA2" runat="server" Visible="false" />
</asp:Panel>
</ContentTemplate>
</asp:UpdatePanel>
</ContentTemplate>
...
<asp:Panel ID="TabContent6" runat="server" Visible="false"><uc4:AcceptLinac ID="AcceptLinac6" LinacName="LA2" UserReason="6" Tabby="6" runat="server" visible="false"/>
<%--<uc8:WebUserControl2 ID="WebUserControl21" LinacName="LA2" runat="server" Visible="false" />--%>
 <uc10:PhysicsQAuc ID="PhysicsQAuc1" LinacName="LA2"  Visible="false" runat="server" />
 </asp:Panel>
 </ContentTemplate>
 </asp:UpdatePanel>
 </ContentTemplate>
...
<asp:TabPanel ID="TabPanel7" runat="server" HeaderText="LA2 Emergency Runup" DynamicContextKey='Emerunup' CssClass="ajax__tab_header">
     <ContentTemplate>
...
<uc4:AcceptLinac ID="AcceptLinac7" runat="server" LinacName= "LA2"  Tabby="7" UserReason = "9" visible="false" />
<uc1:ErunupUserControl ID="ErunupUserControl2" LinacName="LA2" Tabby = "7" UserReason = "9" DataName="EmeData" visible="false" runat="server"  />
</asp:Panel>
</ContentTemplate>
</asp:UpdatePanel>
</ContentTemplate>
...
<asp:TabPanel ID="TabPanel8" runat="server" HeaderText="LA2 Development/Training" DynamicContextKey='Devel' CssClass="ajax__tab_header"><ContentTemplate>
...
<uc4:AcceptLinac ID="AcceptLinac8" runat="server" LinacName= "LA2"  Tabby="8" UserReason = "8" visible="false" />
<uc12:Traininguc ID="Traininguc1" LinacName = "LA2" Tabby="8" UserReason="8" Visible="false" runat="server" />
</asp:Panel>
</ContentTemplate>
</asp:UpdatePanel>
</ContentTemplate>
