...
<%--<uc4:AcceptLinac ID="AcceptLinac1" runat="server" LinacName= "T3"  Tabby="1" UserReason = "1" visible="false" />--%>
...
<%--<uc4:AcceptLinac ID="AcceptLinac2" LinacName="T3" UserReason="2" Tabby="2" runat="server" visible="false"/>--%>
<uc2:Preclinusercontrol ID="Preclinusercontrol1" LinacName = "T3" DataName="PreData" runat="server"/>
</asp:Panel>
</ContentTemplate>
</asp:UpdatePanel>
</ContentTemplate>
...
<%--<uc4:AcceptLinac ID="AcceptLinac3" LinacName="T3" UserReason="3" Tabby="3" runat="server"  />--%>
...
<%--<uc4:AcceptLinac ID="AcceptLinac4" LinacName="T3" UserReason="4" Tabby="4" runat="server" visible="false"/>--%>
...
<%--<uc4:AcceptLinac ID="AcceptLinac5" LinacName="T3" UserReason="5" Tabby="5" runat="server" visible="false"/>--%>
...
<%--<asp:Panel ID="TabContent6" runat="server" Visible="false"><uc4:AcceptLinac ID="AcceptLinac6" LinacName="T3" UserReason="6" Tabby="6" runat="server" visible="false"/></asp:Panel>--%>
...
<asp:TabPanel ID="TabPanel8" runat="server" HeaderText="T3 Development/Training" DynamicContextKey='Devel' CssClass="ajax__tab_header"><ContentTemplate>
...
<%--<uc4:AcceptLinac ID="AcceptLinac8" runat="server" LinacName= "T3"  Tabby="8" UserReason = "8" visible="false" />--%>
