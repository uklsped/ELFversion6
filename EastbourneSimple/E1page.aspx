...
<asp:TabPanel runat="server" HeaderText="E1 Status" ID="TabPanel0">
<HeaderTemplate>
E1 Status
</HeaderTemplate>
<ContentTemplate>
...
<asp:TabPanel ID="TabPanel1" runat="server" HeaderText="E1 Engineering Runup" DynamicContextKey='Engrunup' CssClass="ajax__tab_header">
    <ContentTemplate>
...
<uc4:AcceptLinac ID="AcceptLinac1" runat="server" LinacName= "E1"  Tabby="1" UserReason = "1" visible="false" />
   <uc1:ErunupUserControlCommon ID="ErunupUserControl1" LinacName="E1" UserReason = "1" DataName="EngData" visible="false" runat="server" />
...
<uc1:ErunupUserControlCommon ID="ErunupUserControl2" LinacName="E1" UserReason = "9" DataName="EmeData" visible="false" runat="server" />
</asp:Panel>
</ContentTemplate>
</asp:UpdatePanel>
</ContentTemplate>
...
<asp:TabPanel ID="TabPanel8" runat="server" HeaderText="E1 Development/Training" DynamicContextKey='Devel' CssClass="ajax__tab_header">
<ContentTemplate>
