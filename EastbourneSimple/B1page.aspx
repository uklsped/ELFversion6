 ...
 <asp:HiddenField ID="LAHiddenFieldcontrol" runat="server" />
  ...
  <input id="inpHide" type="hidden" runat="server" value="9" />
    ...
    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
            ...
            <uc9:WriteDatauc ID="WriteDatauc1" LinacName="B1" UserReason="10"  Tabby="EndDay"  WriteName="EndDayData"   Visible="False" runat="server" />
...
<asp:TabPanel runat="server" HeaderText="B1 Status" ID="TabPanel0">
<HeaderTemplate>
B1 Status
</HeaderTemplate>
<ContentTemplate>
...
<asp:TabPanel ID="TabPanel1" runat="server" HeaderText="B1 Engineering Runup" DynamicContextKey='Engrunup' CssClass="ajax__tab_header">
    <ContentTemplate>
...
<uc4:AcceptLinac ID="AcceptLinac1" runat="server" LinacName= "B1"  Tabby="1" UserReason = "1" visible="false" />
   <uc1:ErunupUserControlCommon ID="ErunupUserControl1" LinacName="B1" UserReason = "1" DataName="EngData" visible="false" runat="server" />
...
<uc4:AcceptLinac ID="AcceptLinac3" LinacName="B1" UserReason="3" Tabby="3" runat="server"  />
...
<uc4:AcceptLinac ID="AcceptLinac4" LinacName="B1" UserReason="4" Tabby="4" runat="server" visible="false"/>
...
<uc4:AcceptLinac ID="AcceptLinac5" LinacName="B1" UserReason="5" Tabby="5" runat="server" visible="false"/>
...
<uc1:ErunupUserControlCommon ID="ErunupUserControl2" LinacName="B1" UserReason = "9" DataName="EmeData" visible="false" runat="server" />
</asp:Panel>
</ContentTemplate>
</asp:UpdatePanel>
</ContentTemplate>
...
<asp:TabPanel ID="TabPanel8" runat="server" HeaderText="B1 Development/Training" DynamicContextKey='Devel' CssClass="ajax__tab_header">
<ContentTemplate>
...
<uc4:AcceptLinac ID="AcceptLinac8" runat="server" LinacName= "B1"  Tabby="8" UserReason = "8" visible="false" />
