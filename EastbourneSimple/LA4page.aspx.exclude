...
<uc4:AcceptLinac ID="AcceptLinac1" runat="server" LinacName= "LA4"  Tabby="1" UserReason = "1" visible="false" />
    <uc1:ErunupUserControlCommon ID="ErunupUserControl1" LinacName="LA4" Tabby = "1" UserReason = "1" DataName="EngData" visible="false" runat="server" />
...
<uc4:AcceptLinac ID="AcceptLinac7" runat="server" LinacName= "LA4"  Tabby="7" UserReason = "9" visible="false" />
 <uc1:ErunupUserControlCommon ID="ErunupUserControl2" LinacName="LA4" Tabby = "7" UserReason = "9" DataName="EmeData" visible="false" runat="server" />
