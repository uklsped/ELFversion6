...
Partial Public Class LA2page
    Inherits System.Web.UI.Page
    Private EquipmentID As String = "LA2"
    ...
    Private LinacFlag As String = "StateLA2"
    Private appstate As String = "LogOnLA2"
    Private suspstate As String = "SuspendedLA2"
    Private actionstate As String = "ActionStateLA2"
    Private repairstate As String = "rppTabLA2"
    Private failstate As String = "FailStateLA2"
    Private clinicalstate As String = "ClinicalOnLA2"
    Private treatmentstate As String = "TreatmentLA2"
    Private activetabstate As String = "ActTabLA2"
    ...
    Private faultstate As String = "faultstateLA2"
    Private linacloaded As String = "LA2loaded"
    Private returnclinical As String = "ReturnClinicalLA2"
    Private technicalstate As String = "techstateLA2"
    ...
    Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
        ...
        End If
        AddHandler LA2page.NoApprove, AddressOf ClinicalApprovedEvent
    ...
    Public Event MyEventLA2 As System.EventHandler
    ...
    Protected Sub ReportFault_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ReportFault.Click
        ...
        End If
        'Response.Redirect("faultPage.aspx?val=LA2&Tabindex=" & Tabindex & "&commentbox=" & textcomment)
    ...
    '    'Response.Redirect("RegisterUser.aspx?val=LA2&Tabindex=" & Tabindex)
    'End Sub
    ...
    Public Shared Sub CloseMessage()
        ...
        Try
            Dim lastState As String
            lastState = DavesCode.Reuse.GetLastState("LA2", 0)
            Select Case lastState
                Case "Repair", "Fault"
                    DavesCode.Reuse.SetStatus("No User", "Repair", 5, 7, "LA2", 0)
                Case Else
                    DavesCode.Reuse.SetStatus("No User", "Linac Unauthorised", 5, 7, "LA2", 0)
            End Select
        Finally
