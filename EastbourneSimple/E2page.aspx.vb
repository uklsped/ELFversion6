...
Partial Public Class E2page
    ...
    Private LinacFlag As String = "StateE2"
    Private appstate As String = "LogOnE2"
    Private suspstate As String = "SuspendedE2"
    Private actionstate As String = "ActionStateE2"
    Private repairstate As String = "rppTabE2"
    Private failstate As String = "FailStateE2"
    Private clinicalstate As String = "ClinicalOnE2"
    Private treatmentstate As String = "TreatmentE2"
    Private activetabstate As String = "ActTabE2"
    ...
    Private faultstate As String = "faultstateE2"
    Private linacloaded As String = "E2loaded"
    Private returnclinical As String = "ReturnClinicalE2"
    Private technicalstate As String = "techstateE2"
    ...
    Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
        ...
        End If
        AddHandler E2page.NoApprove, AddressOf ClinicalApprovedEvent
    ...
    Public Event MyEventE2 As System.EventHandler
    ...
    Protected Sub ReportFault_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ReportFault.Click
        ...
        End If
        'Response.Redirect("faultPage.aspx?val=E2&Tabindex=" & Tabindex & "&commentbox=" & textcomment)
    ...
    '    'Response.Redirect("RegisterUser.aspx?val=E2&Tabindex=" & Tabindex)
    'End Sub
    ...
    Public Shared Sub CloseMessage()
        ...
        Try
            Dim lastState As String
            lastState = DavesCode.Reuse.GetLastState("E2", 0)
            Select Case lastState
                Case "Repair", "Fault"
                    DavesCode.Reuse.SetStatus("No User", "Repair", 5, 7, "E2", 0)
                Case Else
                    DavesCode.Reuse.SetStatus("No User", "Linac Unauthorised", 5, 7, "E2", 0)
            End Select
        Finally
