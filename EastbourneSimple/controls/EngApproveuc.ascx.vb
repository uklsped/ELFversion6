...
Partial Class controls_EngApproveuc
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        If Not IsPostBack Then
            ...
            EnergyGridView.DataSource = SqlDataSource1
                ...
                While reader.Read()
                    ...
                    If Not IsDBNull(reader.Item("Approved")) Then
                        If Not reader.Item("Approved") Then
                            Dim cb As CheckBox = CType(EnergyGridView.Rows(count).FindControl("RowLevelCheckBox1"), CheckBox)
                            cb.Enabled = False
                            cb.Visible = False
                        End If
                    Else
    ...
    Protected Sub Checked(ByVal sender As Object, ByVal e As System.EventArgs)
        Dim toggle As CheckBox = CType(EnergyGridView.HeaderRow.FindControl("chkSelectAll"), CheckBox)

        If toggle.Checked = True Then

            For Each grv As GridViewRow In EnergyGridView.Rows
    ...
    Protected Function ConfirmNoRadConcession() As Boolean
        ...
        comm.Parameters.AddWithValue("@linac", Device)
