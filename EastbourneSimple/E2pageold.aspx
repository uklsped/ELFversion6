<%@ Page Title="" Language="VB" MasterPageFile="~/Elf.master"  AutoEventWireup="false" CodeFile="E2pageold.aspx.vb" Inherits="E2page"  %>
...
<asp:UpdatePanel ID="linacstatus" runat="server" >
    <ContentTemplate>
<%--<uc4:AcceptLinac ID="AcceptLinac0" LinacName= "E2"  UserReason = "1"  Tabby="0" runat="server" />--%>
...
<%--<uc8:WebUserControl2 ID="WebUserControl21" LinacName="E2" runat="server" Visible="false" />--%>
