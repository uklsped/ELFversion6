...
Partial Public Class T3page
    ...
    Private actionstate As String = "ActionStateT3"
    Private RunUpDone As String = "rppTabT3"
    Private FaultOriginTab As String = "FOTT3"
    Private clinicalstate As String = "ClinicalOnT3"
    Private treatmentstate As String = "TreatmentT3"
    Private activetabstate As String = "ActTabT3"
    ...
    Private faultstate As String = "OpenFaultT3"
    Private linacloaded As String = "T3loaded"
    Private returnclinical As String = "ReturnClinicalT3"
    Private technicalstate As String = "techstateT3"
    Private recover As String = Nothing
    Private lsctrl As LinacStatusuc
    Private RegistrationState As String = "regstateT3"
    ...
    Private RecoverFault As String = "RecoverFaultT3"
    ...
    Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
        DavesCode.Reuse.RecordStates("T3", 0, "T3PageInit", 0)
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        lastState = DavesCode.Reuse.GetLastState(EquipmentID, 0)
        Statelabel.Text = lastState
        'DavesCode.Reuse.RecordStates("T3", 0, "T3Pageload1", 0)
        If Not IsPostBack Then
            DavesCode.Reuse.RecordStates("T3", 0, "T3PageloadPostback", 0)
    ...
    Public Event MyEventT3 As System.EventHandler
    ...
    '    'Response.Redirect("RegisterUser.aspx?val=T3&Tabindex=" & Tabindex)
    'End Sub
    ...
    Public Shared Sub CloseMessage()
        ...
        Try
            Dim lastState As String
            lastState = DavesCode.Reuse.GetLastState("T3", 0)
            Select Case lastState
                Case "Repair", "Fault"
                    DavesCode.Reuse.SetStatus("No User", "Repair", 5, 7, "T3", 0)
                Case Else
                    DavesCode.Reuse.SetStatus("No User", "Linac Unauthorised", 5, 7, "T3", 0)
            End Select
        Finally
