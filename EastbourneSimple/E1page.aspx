...
<asp:TabPanel ID="TabPanel2" runat="server" HeaderText="E1 Pre-clinical Runup" >
        <ContentTemplate>
...
<asp:TabPanel ID="TabPanel7" runat="server" HeaderText="E1 Emergency Runup" DynamicContextKey='Emerunup' CssClass="ajax__tab_header">
     <ContentTemplate>
...
<uc4:AcceptLinac ID="AcceptLinac7" runat="server" LinacName= "E1"  Tabby="7" UserReason = "9" visible="false" />
 <uc1:ErunupUserControlCommon ID="ErunupUserControl2" LinacName="E1" Tabby = "7" UserReason = "9" DataName="EmeData" visible="false" runat="server" />
