...
<asp:TabPanel runat="server" HeaderText="B2 Status" ID="TabPanel0">
<HeaderTemplate>
B2 Status
</HeaderTemplate>
<ContentTemplate>
...
<asp:TabPanel ID="TabPanel1" runat="server" HeaderText="B2 Engineering Runup" DynamicContextKey='Engrunup' CssClass="ajax__tab_header">
    <ContentTemplate>
...
<uc4:AcceptLinac ID="AcceptLinac1" runat="server" LinacName= "B2"  Tabby="1" UserReason = "1" visible="false" />
   <uc1:ErunupUserControlCommon ID="ErunupUserControl1" LinacName="B2" UserReason = "1" DataName="EngData" visible="false" runat="server" />
...
<uc4:AcceptLinac ID="AcceptLinac6" LinacName="B2" UserReason="6" Tabby="6" runat="server" visible="false"/>
</asp:Panel>
</ContentTemplate>
</asp:UpdatePanel>
</ContentTemplate>
...
<uc1:ErunupUserControlCommon ID="ErunupUserControl2" LinacName="B2" UserReason = "9" DataName="EmeData" visible="false" runat="server" />
</asp:Panel>
</ContentTemplate>
</asp:UpdatePanel>
</ContentTemplate>
...
<asp:TabPanel ID="TabPanel8" runat="server" HeaderText="B2 Development/Training" DynamicContextKey='Devel' CssClass="ajax__tab_header">
<ContentTemplate>
