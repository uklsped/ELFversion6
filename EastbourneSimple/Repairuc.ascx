...
<%@ Register src="WebUserControl2.ascx" tagname="WebUserControl2" tagprefix="uc4" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server" >
    <ContentTemplate>
        <%--<asp:Button ID="viewnewFault" runat="server" Text="View New Fault" CausesValidation="false" />--%>
