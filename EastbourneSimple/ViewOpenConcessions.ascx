<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ViewOpenConcessions.ascx.vb" Inherits="ViewOpenConcessions" %>
...
<uc2:ManyFaultGriduc ID="ManyFaultGriduc" runat="server" />
