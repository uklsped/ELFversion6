...
Partial Public Class E1page
    ...
    Private LinacFlag As String = "StateE1"
    Private appstate As String = "LogOnE1"
    Private suspstate As String = "SuspendedE1"
    Private actionstate As String = "ActionStateE1"
    Private repairstate As String = "rppTabE1"
    Private failstate As String = "FailStateE1"
    ...
    Private technicalstate As String = "techstateE1"
    ...
    Public Event MyEventE1 As System.EventHandler
    ...
    Protected Sub ReportFault_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ReportFault.Click
        ...
        End If
        'Response.Redirect("faultPage.aspx?val=E1&Tabindex=" & Tabindex & "&commentbox=" & textcomment)
    ...
    '    'Response.Redirect("RegisterUser.aspx?val=E1&Tabindex=" & Tabindex)
    'End Sub
