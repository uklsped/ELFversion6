...
Partial Public Class E2page
    ...
    Private RunUpDone As String = "rppTabE2"
    Private FaultOriginTab As String = "FOTE2"
    ...
    Private faultstate As String = "OpenFaultE2"
    ...
    Public Shared Sub CloseMessage()
        ...
        Try
            ...
            Select Case lastState
                Case "Repair", "Fault"
                    DavesCode.Reuse.SetStatus("No User", "Repair", 5, 7, "E2", 0, False)
                Case Else
                    DavesCode.Reuse.SetStatus("No User", "Linac Unauthorised", 5, 7, "E2", 0, False)
            End Select
        Finally
